...
$refrom_name = "医療法人社団 創輝会グループ ピル処方窓口";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "医療法人社団 創輝会グループ ピル処方窓口";
...
ご希望の時間になりましたら
LINEにて、医師から通話のご連絡を差し上げます。


【重要】オンライン診療受診における注意事項

・事前に保険証と医療証、または診療情報をお手元にご用意ください。
・必ずご本人がオンライン診療をお受けください。
・初診オンライン診療の場合は、症状によりオンライン診療が適されない場合がございます。その場合は対面診療をご案内いたします。
・オンライン診療後、対面診療が必要となるケースがございますので、物理的にご来院いただける地域の方のみとさせていただきます。
・診療後に、診察代をご請求いたします。クレジットカード決済用のURLをお送りいたします。

※未成年の方は以下にアクセスし、同意書をご記入の上、写真添付を行ってお送りください。
https://souki-kai.or.jp/pdf/under18.pdf
...
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<a href="./index.html">トップページへ戻る&raquo;</a>
</div>
