...
var time02 = new Date();
var full__year02 = time.getFullYear();

for (var i = 1960; i <= full__year02; i++) {
    $('#year02').append('<option value="' + i + '年">' + i + '</option>');
}
...
/* 各ステップのスクロールポジション取得 */
var pos_step02_02 = $("#js-form-step02-02").offset().top;
var pos_step03 = $("#js-form-step03").offset().top;
var pos_step04 = $("#js-form-step04").offset().top;
var pos_step05 = $("#js-form-step05").offset().top;
//var pos_step06 = $("#js-form-step06").offset().top;
var pos_step07 = $("#js-form-step07").offset().top;
...
$(function () {
    ...
    $("#js-to-step04").on('click', function () {
        //エラーの初期化
        $("#js-form-step02-02 .error-massege").remove();
        //選択または入力してなかったらエラーメッセージ表示
        $("#js-form-step02-02 .required").each(function () {
            if ($(this).val() === "") {
                $(this).parent().append("<p class='error-massege'>必須項目です</p>");
        ...
        if ($('#js-form-step02-02 .error-massege').length) {
            $('html,body').animate({ scrollTop: $("#js-form-step02-02 .error-massege:first").offset().top - 45 });
        }
        //エラーがなければ、次のステップへ進む
        else {
            $("#js-form-step02-02").removeClass("is-step-show");
...
$("#js-prev-step02-02").on("click", function () {
    $("#js-form-step03").removeClass("is-step-show");
    pos_step02_02 = $("#js-form-step02-02").offset().top;
    $("html,body").animate({ scrollTop: pos_step02_02 }, '500');
    $("#js-form-step02-02").addClass("is-step-show");
});
...
$("#js-prev-step05").on("click", function () {
    $("#js-form-step06").removeClass("is-step-show");
    pos_step03 = $("#js-form-step05").offset().top;
    $("html,body").animate({ scrollTop: pos_step03 }, '500');
    $("#js-form-step05").addClass("is-step-show");
});
...
$(function () {
    ...
    $("#js-to-step05").on('click', function () {
        ...
        //エラーがなければ、次のステップへ進む
            ...
            $("#js-form-step03").removeClass("is-step-show");
            $("#js-form-step04").addClass("is-step-show");
            pos_step04 = $("#js-form-step04").offset().top;
...
$(function () {
    ...
    $("#js-to-step06").on('click', function () {
        ...
        //ラジオボタンのチェック
        $(":radio").filter("#js-form-step04 .required").each(function () {
        ...
        //エラーがなければ、次のステップへ進む
            ...
            $("#js-form-step04").removeClass("is-step-show");
            $("#js-form-step05").addClass("is-step-show");
            pos_step05 = $("#js-form-step05").offset().top;
...
$(function () {
    ...
    $("#js-to-step07").on('click', function () {
        ...
        if ($('#js-form-step05 .error-massege').length) {
            $('html,body').animate({ scrollTop: $("#js-form-step05 .error-massege:first").offset().top - 80 });
        }
        //エラーがなければ、次のステップへ進む
        else {
            $("#js-form-step05").removeClass("is-step-show");
...
$(function () {
    ...
    $("#js-to-step08").on('click', function () {
        //エラーの初期化
        $("#js-form-step06 .error-massege").remove();
        //選択または入力してなかったらエラーメッセージ表示
        $("#js-form-step06 .required").each(function () {
            if ($(this).val() === "") {
                $(this).parent().append("<p class='error-massege'>必須項目です</p>");
            }
        });
        ...
        //ラジオボタンのチェック
        $("input[type='radio']").filter("#js-form-step06  .required").each(function () {
            if ($("input[name=" + $(this).attr("name") + "]:checked").size() == 0) {
                $(this).parent().prepend("<p class='error-massege'>選択してください</p>")
            }
        });
        ...
        //エラーメッセージが存在していたら、最初のエラーメッセージへスクロール
        if ($('#js-form-step06 .error-massege').length) {
            $('html,body').animate({ scrollTop: $("#js-form-step06 .error-massege:first").offset().top - 45 });
        }
        //エラーがなければ、次のステップへ進む
        else {
            $("#js-form-step06").removeClass("is-step-show");
